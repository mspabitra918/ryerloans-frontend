export default function CommunicationsConsentHero() {
    ...
    <section className="pt-24 pb-16 px-4 bg-[#030712] border-b border-[#1f293d]">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <p className="text-slate-400 text-base sm:text-lg max-w-2xl leading-relaxed">
          Telephone Consumer Protection Act (TCPA) consent, phone/SMS messaging
          guidelines, servicing notifications, and opt-out procedures.
        </p>
      </div>
    </section>
  );
