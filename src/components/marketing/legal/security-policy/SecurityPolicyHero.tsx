export default function SecurityPolicyHero() {
    ...
    <section className="pt-24 pb-16 px-4 bg-[#030712] border-b border-[#1f293d]">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <p className="text-slate-400 text-base sm:text-lg max-w-2xl leading-relaxed">
          How we protect your data with end-to-end encryption, strict access
          controls, anti-fraud guidelines, and FTC Safeguards compliance.
        </p>
      </div>
    </section>
  );
