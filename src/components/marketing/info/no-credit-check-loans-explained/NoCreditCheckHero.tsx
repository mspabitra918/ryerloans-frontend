...
export default function NoCreditCheckHero() {
    ...
    <section className="pt-24 pb-16 px-4 bg-[#030712] border-b border-[#1f293d]">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight max-w-4xl">
          "No Credit Check Loans": What That Phrase Actually Means
        </h1>

        {/* Subtitle */}
        <p className="text-slate-400 text-base sm:text-lg max-w-3xl leading-relaxed">
          An honest look at soft vs. hard inquiries, alternative credit
          reporting databases, the true mathematical cost of no-verification
          loans, and red flags to avoid when searching for flexible credit.
        </p>
      </div>
    </section>
  );
