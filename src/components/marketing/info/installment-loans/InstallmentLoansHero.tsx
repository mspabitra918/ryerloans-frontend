...
export default function InstallmentLoansHero() {
      ...
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="flex items-center gap-3 text-xs font-mono">
          <span className="text-sky-400 uppercase tracking-widest font-semibold flex items-center gap-1.5">
            ...
            Product & Financial Structure Guide
          </span>
        ...
        <p className="text-slate-400 text-base sm:text-lg max-w-3xl leading-relaxed">
          How fixed lump-sum borrowing works, direct comparison against credit
          cards and payday loans, amortization mechanics, and choosing the
