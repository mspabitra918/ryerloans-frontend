...
export default function UnsecuredLoansHero() {
    ...
    <section className="pt-24 pb-16 px-4 bg-[#030712] border-b border-[#1f293d]">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <p className="text-slate-400 text-base sm:text-lg max-w-3xl leading-relaxed">
          Understand how unsecured borrowing works, how lenders evaluate risk
          without asset backing, key differences from secured loans, and the
          exact consequences of default.
        </p>
      </div>
    </section>
  );
