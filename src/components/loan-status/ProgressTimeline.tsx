...
export default function ProgressTimeline({ data }: { data: ApplicationData }) {
  const isTerminal =
    data.fundingStatus === "declined" || data.fundingStatus === "withdrawn";
      ...
      <div className="space-y-6 relative before:absolute before:inset-0 before:left-3 sm:before:left-4 before:w-0.5 before:bg-slate-200 before:z-0">
        ...
        <div className="relative z-10 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 capitalize">
              {isTerminal && data.bankStatus !== "completed"
                ? "Not completed"
                : data.bankStatus}
            </p>
          </div>
        ...
        <div className="relative z-10 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 capitalize">
              {isTerminal && data.depositStatus !== "confirmed"
                ? "Not completed"
                : data.depositStatus.replace("_", " ")}
            </p>
          </div>
        ...
        <div className="relative z-10 flex items-start gap-4">
          ...
          <div>
            <h4 className="font-bold text-slate-900 text-sm">Final Decision</h4>
            <p className="text-xs text-slate-500 capitalize">
