...
export default function ActionAlerts({ data }: { data: ApplicationData }) {
  ...
  return (
    <div className="space-y-4">
          ...
          {data.bankStatus === "pending" ? (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-sky-900 leading-relaxed">
                    ...
                    password is never shared with {RATE_CONFIG.name}.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 flex items-center gap-3 text-emerald-950 text-sm">
              ...
              <span>
                ...
                {data.bankCompletedDate}. Nothing further needed on this step.
              </span>
            </div>
          )}
        </>
      ...
      {/* Withdrawn State */}
      {data.fundingStatus === "withdrawn" && (
        <div className="bg-slate-50 border-2 border-slate-200 rounded-2xl p-6 shadow-sm space-y-2 text-slate-900">
          <div className="flex items-center gap-3">
            <XCircle className="w-6 h-6 text-slate-500 flex-shrink-0" />
            <h3 className="font-bold text-xl">Application Withdrawn</h3>
          </div>
          <p className="text-sm leading-relaxed pl-9 text-slate-600">
            This application was marked as withdrawn on{" "}
            <strong>{data.withdrawnDate}</strong>. If you believe this is an
            error or would like to submit a new application, please contact
            support.
          </p>
        </div>
      )}
